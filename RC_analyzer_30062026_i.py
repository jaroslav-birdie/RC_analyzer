...
# =============================================================================
    ...
    def get_bg_for_segmentation(self):
        ...
        # no valid background ROI (not drawn yet, or a degenerate single-point selection) -> nothing to compute
        if (self.roi_bg == [0]) or (background is None) or (background[0][0] == background[1][0]):
            return
