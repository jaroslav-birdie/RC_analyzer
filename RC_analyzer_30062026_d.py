...
class mainWindow:
    def __init__(self, master):
        ...
        # MIP views stacked vertically in a single column - LEFT projection on top, UP projection below
        ...
        self.mip_LEFT_view.grid(row=0, column=0, sticky='nsew')
        ...
        self.mip_UP_view.grid(row=1, column=0, sticky='nsew')
