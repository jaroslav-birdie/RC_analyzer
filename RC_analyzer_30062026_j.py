...
#-------------------------------------------------------------------------------------------
    ...
    def get_out_results(self, file_path):
        ...
        # RC_max, RC_A<thresh>, RC_peak, CRC_max, CRC_A<thresh>, CRC_peak, diameter, bg_real, bg_measured, bg_diff(%), bg_COV(%)
        ...
        # so the 4 bg values align under bg_real, bg_measured, bg_diff(%), bg_COV(%)
...
class mainWindow:
    def __init__(self, master):
        ...
        self.frame_h.grid(row=1, column=2, columnspan=1, sticky='ew')
