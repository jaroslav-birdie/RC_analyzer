...
| `RC_analyzer_30062026_g.py` | **Adaptivní downsampling** podle velikosti matice (rows×cols): <200 → bez downsamplingu (1), 200–399 → faktor 2, ≥400 → faktor 4. Volí se automaticky při načtení dat. **Aktuální pracovní verze.** |
